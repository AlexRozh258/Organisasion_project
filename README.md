...
Сайт "Куди піти?" дозволяє зберігати улюблені місця (ресторани, парки, розваги) та випадковим чином обирати, куди піти сьогодні.
...
git clone https://github.com/AlexRozh258/Organisation_project.git
